...
- A dope ass screen for playing song with title, audio and display shit (_native Album cover art support for kitty terminal is on it's way too_)
...
- there are no typewriters yet (but lowkey...I am getting closer to become spotify)
...
- [ ] DATABASE MIGRATION AND CLEAN UP
...
./ShittyJukeBox # To see the menus and shit
./ShittyJukeBox --preview #For inital draft of how the display happens and shit AND NO THERE IS NO SOUND YET
